	...
	return (
		<>
			<div className="bg-zinc-100 p-[5%] flex flex-col items-center justify-center space-y-10">
				...
				<button className="bg-[#2e8284] px-10 py-2 text-white">SIGN UP</button>
			</div>
			{/* Testimonials */}
			<div className="p-[5%]">
				<div>
					<div className="flex items-center">
						<div className="w-7 h-[3px] bg-[#2e8284] mr-5"></div>
						<small className="font-semibold text-base uppercase text-[#2e8284]">Testimonials</small>
					</div>
